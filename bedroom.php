 ...
 <body>
     ...
     <div class="wrapp">
         <!-- Card 1-->
         <div class="card">
             <img src="images6/images.jpg">
             <div class="info">
                 <h1>Harper Marble Sideboard</h1>
                 <p>Model:Sideboard<br>Color: Chestnut<br>$1,899
                 </p>
         ...
         <div class="card">
             <img src="images6/img15.webp">
             <div class="info">
                 <h1>Harper Bed</h1>
                 <p>Model:Bed<br>Color: Natural<br>$1,000</p>
                 <a href="#" class="btn0">Read more</a>
         ...
         <div class="card">
             <img src="images6/img14.jpg">
             <div class="info">
                 <h1>Harper Bed</h1>
                 <p>Model:Bed<br>Color: Chestnut<br>$1,099
                 </p>
                 <a href="#" class="btn0">Read more</a>
             </div>
         </div>
