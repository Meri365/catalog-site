...
<body>
    ...
    <div class="wrapp">
        <!-- Card 1-->
        <div class="card">
            <img src="images6/img11.webp">
            <div class="info">
                <h1>Vincent Dining Table</h1>
                <p>Model:Walnut Table<br>Length: 59"<br>$800
                </p>
        ...
        <div class="card">
            ...
            <div class="info">
                <h1>Vincent Dining Table, Walnut</h1>
                <p>Model:Walnut Table<br>Length: 59"<br>$899
                </p>
                <a href="#" class="btn0">Read more</a>
        ...
        <div class="card">
            <img src="images6/img12.webp">
            <div class="info">
                <h1>Vincent Dining Table</h1>
                <p>Model:Walnut Table<br>Length: 70"<br>$940</p>
                <a href="#" class="btn0">Read more</a>
            </div>
        </div>
    </div>
