 ...
 <body>
     ...
     <div class="wrapp">
         <!-- Card 1-->
         <div class="card">
             <img src="images6/download.jpg">
             <div class="info">
                 <h1>Large wardrobe with mirrored doors</h1>
                 <p>Color։Silver<br>$500
                 </p>
         ...
         <div class="card">
             <img src="images6/img17.jpg">
             <div class="info">
                 <h1>3-door wardrobe, wood-metal combination</h1>
                 <p>Color:Champagne<br>$150
                 </p>
                 <a href="#" class="btn0">Read more</a>
